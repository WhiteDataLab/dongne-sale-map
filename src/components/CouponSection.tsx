        ...
        <div className="min-w-0 flex-1 p-3">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              ...
              {coupon.condition && (
                <p className="mt-0.5 truncate text-xs text-gray-500">{coupon.condition}</p>
              )}
              {coupon.description && (
                <p className="mt-0.5 line-clamp-2 text-xs text-gray-400">{coupon.description}</p>
              )}
            </div>
            {used && (
            ...
            {canManage ? (
              <div className="flex shrink-0 items-center gap-1.5">
                ...
                <button
                  ...
                  className="rounded-lg border border-gray-300 px-2.5 py-1 text-[11px] font-medium text-red-500 hover:bg-red-50 disabled:opacity-50"
                >
                  삭제
                </button>
              </div>
  ...
  return (
    <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div>
          <p className="mb-1 text-xs text-gray-500">유효기간</p>
        ...
        <div className="mt-1 flex gap-2">
          <button
            type="button"
            onClick={onCancel}
            className="flex-1 rounded-lg border border-gray-300 py-2 text-sm font-medium text-gray-500"
          >
            취소
          </button>
          <button
